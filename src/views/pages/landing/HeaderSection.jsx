                    ...
                    <Grid container spacing={6}>
                            ...
                            >
                                <Stack spacing={1}>
                                    <Typography textAlign={{ xs: 'center', md: 'left' }} variant="h1" sx={headerSX}>
                                        Outstanding Mails Deliverability
                                    </Typography>
                        ...
                        <Grid item xs={12} sx={{ mt: -2.5, textAlign: { xs: 'center', md: 'left' } }}>
                            ...
                            >
                                ...
                                >
                                    As the industry leader in deliverability, we invite you to experience MegaMailer.io firsthand to understand why our customers rave about us. Many who depart eventually return, attesting to the unparalleled quality of our service.
                                </Typography>
                            </motion.div>
                        </Grid>
                        <Grid item xs={12}>
